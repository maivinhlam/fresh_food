                ...
                <div class="col-md-6">
                    <div class="float-right">
                        <button type="button" href="#" title="add new user" data-type="create" class="btn btn-success show_modal_form" data-toggle="modal"
                             data-target="#modalEdit" data-title="Create" data-url="{{ route('users.store')}}" >
                            <i class="fa fa-plus-circle"></i>
                            Create
                        </button>

                        <a href="{{route('users.index')}}" title="refresh table for users" class="btn btn-primary" data-trigger-pjax="1" data-pjax-target="#user-grid">
                    ...
                    @foreach($users as $user)
                        <tr>
                            <th scope="row" class="p-1 d-flex justify-content-center align-items-center">
                                ...
                                ?>
                                {{ (($page -1) * count($users)) + ($loop->index + 1) }}
                            </th>
                            <td>
                                <a href="#">
                                    {{ $user->link }}
                            ...
                            <td class="" >
                                <img src="/{{ $user->image }}" alt="{{ $user->image }}" height="80px">
                            </td>
                            <td class="">
                                {{ $user->creator_id }}
                            </td>
            ...
            <div class="modal-body">
                <form method="POST" action="" id="formProduct" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="user_name" class="control-label">Link:</label>
                        <input type="text" class="form-control" id="user_name" name="link">
                    </div>

                    <div class="form-group">
                        <label for="price" class="control-label">Image Link:</label>
                        <input type="text" class="form-control" id="user_name" name="image_link">
                    </div>
                    <div class="form-group">
